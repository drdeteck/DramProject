...
{
	var div = $("<div>").addClass("card").append($("<img>").addClass("float-left").attr("src", row[indexPictureUrl].v));
	var innerDiv = $("<div class='float-left info'>").append($("<h1>").append(row[indexDistillery].v));
